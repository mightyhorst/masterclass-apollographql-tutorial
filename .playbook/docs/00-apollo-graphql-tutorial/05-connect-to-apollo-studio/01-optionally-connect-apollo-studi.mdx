...
> This section is OPTIONAL. Apollo Studio is a commercial product from the Apollo team. It is not neccesary to complete the rest of this tutorial. Skip this and move to the [next step](#next) to connect the client. 
